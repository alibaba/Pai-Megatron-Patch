...
from megatron_patch.model.mistral.rotary_pos_embedding import RotaryEmbedding
from megatron_patch.model.mistral.rotary_pos_embedding import apply_rotary_pos_emb as apply_mistral_rotary_pos_emb
from .layer import MoE
from .moe_parallel_linear import ColumnParallelLinear, RowParallelLinear
...
class ParallelTransformerLayer(MegatronModule):
    ...
    def __init__(self, config,
        ...
        if num_experts == 1:
            ...
            moe_layer_index = (layer_number-1) // args.expert_interval
            if args.rank == 0:
            ...
            self.mlp = MoE(args.hidden_size,
                           ParallelMLP(config, is_expert=True),
...
class ParallelTransformer(MegatronModule):
    ...
    def __init__(self, config,
        ...
        if self.num_layers == 0:
            ...
            num_experts = [args.num_experts] * (args.num_layers // args.expert_interval)
