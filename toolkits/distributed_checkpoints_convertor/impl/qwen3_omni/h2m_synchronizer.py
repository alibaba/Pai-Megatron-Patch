...
from qwen3_vl.h2m_synchronizer import HF2MGSynchronizer as _HF2MGSynchronizer
from general.synchronizer import ParamType
from general.h2m_synchronizer import HF2MGSynchronizer as BASE
...
class HF2MGSynchronizer(_HF2MGSynchronizer):
    ...
    def set_postprocess_state(self, mg_model, hf_model, is_mamba: bool=False):
        ...
        self.copy(
            self._hfmodel.thinker.lm_head.weight, 
            output_layer_weight, 
    ...
    def set_vision_model_layer_state(self, vision_model, hf_vision_model):
        ...
        self.copy(hf_vision_model.merger.ln_q.bias, vision_model.decoder.final_layernorm.bias)
        ...
        for norm, hf_merger in zip(
            ...
            self.copy(hf_merger.ln_q.weight, norm.weight)
            self.copy(hf_merger.ln_q.bias, norm.bias)
    ...
    def set_weight_and_bias_state(self, module, hf_module):
        self.copy(hf_module.weight, module.weight)
        if hf_module.bias is not None:
            self.copy(hf_module.bias, module.bias)
    ...
    def set_audio_layer_state(self, layer, hf_layer):
        ...
        print(hf_layer.self_attn.k_proj, layer.self_attn.k_proj)
