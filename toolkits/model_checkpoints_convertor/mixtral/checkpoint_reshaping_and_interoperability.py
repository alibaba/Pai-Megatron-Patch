...
transformers_to_megatron = {
    ...
    "mlp.megatron_moe.gate.wg":"mlp.megatron_moe.gate.wg",
    "mlp.megatron_moe.experts.megatron_experts.0.dense_h_to_4h_1":"mlp.megatron_moe.experts.megatron_experts.0.dense_h_to_4h_1",
    "mlp.megatron_moe.experts.megatron_experts.1.dense_h_to_4h_1":"mlp.megatron_moe.experts.megatron_experts.1.dense_h_to_4h_1",
    "mlp.megatron_moe.experts.megatron_experts.2.dense_h_to_4h_1":"mlp.megatron_moe.experts.megatron_experts.2.dense_h_to_4h_1",
    "mlp.megatron_moe.experts.megatron_experts.3.dense_h_to_4h_1":"mlp.megatron_moe.experts.megatron_experts.3.dense_h_to_4h_1",
    "mlp.megatron_moe.experts.megatron_experts.4.dense_h_to_4h_1":"mlp.megatron_moe.experts.megatron_experts.4.dense_h_to_4h_1",
    "mlp.megatron_moe.experts.megatron_experts.5.dense_h_to_4h_1":"mlp.megatron_moe.experts.megatron_experts.5.dense_h_to_4h_1",
    "mlp.megatron_moe.experts.megatron_experts.6.dense_h_to_4h_1":"mlp.megatron_moe.experts.megatron_experts.6.dense_h_to_4h_1",
    "mlp.megatron_moe.experts.megatron_experts.7.dense_h_to_4h_1":"mlp.megatron_moe.experts.megatron_experts.7.dense_h_to_4h_1",
    "mlp.megatron_moe.experts.megatron_experts.0.dense_h_to_4h_2":"mlp.megatron_moe.experts.megatron_experts.0.dense_h_to_4h_2",
    "mlp.megatron_moe.experts.megatron_experts.1.dense_h_to_4h_2":"mlp.megatron_moe.experts.megatron_experts.1.dense_h_to_4h_2",
    "mlp.megatron_moe.experts.megatron_experts.2.dense_h_to_4h_2":"mlp.megatron_moe.experts.megatron_experts.2.dense_h_to_4h_2",
    "mlp.megatron_moe.experts.megatron_experts.3.dense_h_to_4h_2":"mlp.megatron_moe.experts.megatron_experts.3.dense_h_to_4h_2",
    "mlp.megatron_moe.experts.megatron_experts.4.dense_h_to_4h_2":"mlp.megatron_moe.experts.megatron_experts.4.dense_h_to_4h_2",
    "mlp.megatron_moe.experts.megatron_experts.5.dense_h_to_4h_2":"mlp.megatron_moe.experts.megatron_experts.5.dense_h_to_4h_2",
    "mlp.megatron_moe.experts.megatron_experts.6.dense_h_to_4h_2":"mlp.megatron_moe.experts.megatron_experts.6.dense_h_to_4h_2",
    "mlp.megatron_moe.experts.megatron_experts.7.dense_h_to_4h_2":"mlp.megatron_moe.experts.megatron_experts.7.dense_h_to_4h_2",
    "mlp.megatron_moe.experts.megatron_experts.0.dense_4h_to_h":"mlp.megatron_moe.experts.megatron_experts.0.dense_4h_to_h",
    "mlp.megatron_moe.experts.megatron_experts.1.dense_4h_to_h":"mlp.megatron_moe.experts.megatron_experts.1.dense_4h_to_h",
    "mlp.megatron_moe.experts.megatron_experts.2.dense_4h_to_h":"mlp.megatron_moe.experts.megatron_experts.2.dense_4h_to_h",
    "mlp.megatron_moe.experts.megatron_experts.3.dense_4h_to_h":"mlp.megatron_moe.experts.megatron_experts.3.dense_4h_to_h",
    "mlp.megatron_moe.experts.megatron_experts.4.dense_4h_to_h":"mlp.megatron_moe.experts.megatron_experts.4.dense_4h_to_h",
    "mlp.megatron_moe.experts.megatron_experts.5.dense_4h_to_h":"mlp.megatron_moe.experts.megatron_experts.5.dense_4h_to_h",
    "mlp.megatron_moe.experts.megatron_experts.6.dense_4h_to_h":"mlp.megatron_moe.experts.megatron_experts.6.dense_4h_to_h",
    "mlp.megatron_moe.experts.megatron_experts.7.dense_4h_to_h":"mlp.megatron_moe.experts.megatron_experts.7.dense_4h_to_h"
}
...
def merge_transformers_sharded_states_7b(path, num_checkpoints):
    ...
    for i in range(0, num_checkpoints):
        checkpoint_path = os.path.join(path, f"consolidated.{i:02d}.pt")
        ...
        for layer in range(num_layers):
            ...
            for i in range(args.target_tensor_model_parallel_size):
                ...
                for expert_id in range(config.num_local_experts):
                    ...
                    dense_h_to_4h_1_name = 'mlp.megatron_moe.experts.megatron_experts.' + str(expert_id)+'.dense_h_to_4h_1.weight'
                    ...
                    dense_h_to_4h_2_name = 'mlp.megatron_moe.experts.megatron_experts.' + str(expert_id)+'.dense_h_to_4h_2.weight'
        ...
        for tp_rank in range(args.target_tensor_model_parallel_size):
            ...
            for layer_id in range(config.num_hidden_layers):
                for expert_id in range(config.num_local_experts):
                    ...
                    moe_dense_h_to_4h_path = "layers." + str(layer_id)+".mlp.megatron_moe.experts.megatron_experts." + str(expert_id) +".dense_h_to_4h.weight"

                    moe_dense_4h_to_h_path = "layers." + str(layer_id)+".mlp.megatron_moe.experts.megatron_experts." + str(expert_id) +".dense_4h_to_h.weight"

                    moe_state_dict["module.module.language_model.encoder."+moe_dense_h_to_4h_path] = output_state_dict[tp_rank]['model']['language_model']['encoder'][moe_dense_h_to_4h_path]
                    moe_state_dict["module.module.language_model.encoder." + moe_dense_4h_to_h_path] = output_state_dict[tp_rank]['model']['language_model']['encoder'][moe_dense_4h_to_h_path]
                    output_state_dict[tp_rank]['model']['language_model']['encoder'].pop(moe_dense_h_to_4h_path)
