...
sys.path.append(os.path.join(path_dir, "examples/qwen2_5_vl"))
...
def main():
    ...
    if args.convert_checkpoint_from_megatron_to_transformers:
        ...
        hf_model = Qwen2_5_VLForConditionalGeneration.from_pretrained(args.hf_ckpt_path, torch_dtype=config.torch_dtype)
        ...
        hf_model = Qwen2_5_VLForConditionalGeneration.from_pretrained(args.load, torch_dtype=config.torch_dtype)
