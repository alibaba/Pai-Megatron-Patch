...
本文档提供使用 ChatLearn、Mcore 和 vLLM 框架来对Moonlight模型进行GRPO训练的快速开始指南。
...
143行添加trust_remote_code=True,如下所示
...
将"AutoModel"和"AutoModelForCausalLM"修改为指向modeling_deepseek_pai.py文件
"auto_map": {
