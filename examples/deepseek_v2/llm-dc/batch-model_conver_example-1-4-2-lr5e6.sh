...
# 设置基础变量
CHECKPOINT_DIR="/share/liweihao/repos/Pai-Megatron-Patch-LM4DC/examples/deepseek_v2/ckpt-train/DeepSeek-Coder-V2-Lite-Base-to-mcore-tp1-pp4-ep2-ghidra-100k-3e-4/checkpoint/finetune-mcore-deepseek-v2-A2.4B-lr-5e-6-minlr-5e-7-bs-16-gbs-256-seqlen-2048-pr-bf16-tp-1-pp-4-cp-1-ac-full-do-true-sp-true-ti-782-wi-19"
OUTPUT_BASE_DIR="/share/liweihao/repos/Pai-Megatron-Patch-LM4DC/examples/deepseek_v2/ckpt-convert/DeepSeek-Coder-V2-Lite-Base-to-mcore-tp1-pp4-ep2-ghidra-100k-5e-6-to-hf"
...
for iter_dir in $(ls -rd ${CHECKPOINT_DIR}/iter_*); do
    if [ -d "$iter_dir" ]; then
        ...
        if [ $time_diff -lt 330 ]; then  # 300秒 = 5分钟
