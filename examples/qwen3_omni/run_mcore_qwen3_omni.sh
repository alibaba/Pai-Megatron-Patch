...
CURRENT_DIR=/mnt/Pai-Megatron-Patch/examples/qwen3_omni
...
PRETRAIN_CHECKPOINT_PATH=/mnt/qwen3-omni-ckpts/Qwen3-Omni-30B-A3B-Instruct-to-mcore
TRAIN_ITERS=500
LR_WARMUP_ITERS=50
LR_DECAY_ITERS=450
...
echo $cmd
eval $cmd 2>&1 | tee run_qwen3_omni.log ; exit ${PIPESTATUS[0]}
set +x