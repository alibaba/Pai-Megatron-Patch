...
export exp_name=qwen3_8B_seqlen4096_$(date +%F)_fixlr2e_6_${WORLD_SIZE}nodes
...
export tokenizer_load="/mnt/data/jerry.lp/qwen-ckpts/Qwen3-8B"
export load="/mnt/data/jerry.lp/qwen-ckpts/Qwen3-8B-to-mcore/"
